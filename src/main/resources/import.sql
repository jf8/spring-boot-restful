...
--
-- INSERT INTO sys_role(id, name, description, created_by, created_date, last_modified_by, last_modified_date) VALUES (1, 'ROLE_ADMIN', '管理员', NULL, NULL, NULL, NULL);
-- INSERT INTO sys_role(id, name, description, created_by, created_date, last_modified_by, last_modified_date) VALUES (2, 'ROLE_USER', '普通用户', NULL, NULL, NULL, NULL);
--
--
--
