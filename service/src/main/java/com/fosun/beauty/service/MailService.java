...
public class MailService {
    ...
    public MailService(FosunProperties fosunProperties, JavaMailSender javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom(fosunProperties.getMail().getFrom());
    ...
    public void sendEmailFromTemplate(User user, String templateName, String titleKey) {
        ...
        context.setVariable(BASE_URL, fosunProperties.getMail().getBaseUrl());
