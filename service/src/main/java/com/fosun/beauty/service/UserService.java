...
import com.fosun.beauty.service.util.RandomUtil;
...
public class UserService {
    ...
    public User registerUser(UserDTO userDTO, String password) {
        ...
        sysRoleRepository.getFirstByName(AuthoritiesConstants.USER).ifPresent(roles::add);
    ...
    public User createUser(UserDTO userDTO) {
        ...
        if (userDTO.getRoles() != null) {
            Set<SysRole> sysRoles = userDTO.getRoles().stream()
...
//                            .forEach(managedAuthorities::add);
    ...
    public List<String> getResources() {
        return sysResourceRepository.findAll().stream().map(SysResource::getName).collect(Collectors.toList());
    }
    ...
    public List<String> getRoles() {
        return sysRoleRepository.findAll().stream().map(SysRole::getName).collect(Collectors.toList());
    }
