...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    public MetricsConfiguration(FosunProperties fosunProperties) {
    ...
    public void init() {
        ...
        if (hikariDataSource != null) {
            ...
            // remove the factory created by HikariDataSourceMetricsPostProcessor until Fosun migrate to Micrometer
            hikariDataSource.setMetricsTrackerFactory(null);
            hikariDataSource.setMetricRegistry(metricRegistry);
        }
        if (fosunProperties.getMetrics().getJmx().isEnabled()) {
        ...
        if (fosunProperties.getMetrics().getLogs().isEnabled()) {
            ...
            final Slf4jReporter reporter = Slf4jReporter.forRegistry(metricRegistry)
                ...
                .build();
            reporter.start(fosunProperties.getMetrics().getLogs().getReportFrequency(), TimeUnit.SECONDS);
        }
    }
}
