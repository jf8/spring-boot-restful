...
package com.fosun.beauty.common.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    private FosunProperties FosunProperties;

    public CachingHttpHeadersFilter(FosunProperties FosunProperties) {
        this.FosunProperties = FosunProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(FosunProperties.getHttp().getCache().getTimeToLiveInDays());
    }
