...
package com.fosun.beauty.common.config.apidoc;

import com.fosun.beauty.common.config.FosunProperties;
import com.fosun.beauty.common.config.apidoc.customizer.FosunSwaggerCustomizer;
import com.fosun.beauty.common.config.apidoc.customizer.SwaggerCustomizer;
...
import static com.fosun.beauty.common.config.FosunConstants.SPRING_PROFILE_SWAGGER;
...
@AutoConfigureAfter(FosunProperties.class)
@EnableSwagger2
...
public class SwaggerAutoConfiguration {
    ...
    private final FosunProperties.Swagger properties;

    public SwaggerAutoConfiguration(FosunProperties FosunProperties) {
        this.properties = FosunProperties.getSwagger();
    }
    ...
    /**
     * Fosun Swagger Customizer
     *
     * @return the Swagger Customizer of Fosun
     */
    @Bean
    public FosunSwaggerCustomizer FosunSwaggerCustomizer() {
        return new FosunSwaggerCustomizer(properties);
    }
